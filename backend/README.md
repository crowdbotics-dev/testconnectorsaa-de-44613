...
## Project Structure
    ...
    ├── testconnectorsaa_de_44613  # Django project configurations
...
1. Clone this repo and `cd testconnectorsaa_de_44613`
...
2. Clone this repo and `cd testconnectorsaa_de_44613`
